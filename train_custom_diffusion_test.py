        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % 200 == 0:
                    ...
                    unet_path = os.path.join(args.output_dir, f"module-unet-{global_step}")
                    text_encoder_path = os.path.join(args.output_dir, f"module-text_encoder-{global_step}")
                    os.makedirs(unet_path, exist_ok=True)
                    os.makedirs(text_encoder_path, exist_ok=True)

                    # pipeline_to_save = DiffusionPipeline.from_pretrained(
                    #     args.pretrained_model_name_or_path,
                    ...
                    accelerator.unwrap_model(text_encoder).save_pretrained(text_encoder_path)
