...
CUDA_VISIBLE_DEVICES=2 accelerate launch --num_processes=1 --main_process_port=29501 train_custom_diffusion_and_eval.py \
    ...
    --instance_data_dir="celebA/351" \
    --output_dir="outputs/celebA_custom_diffusion_351" \
    ...
    --rho=0.2\
    --alpha=0.5\
    --output_images_dir="evaluation_massive/celebA_custom_diffusion_351"\
    --output_images_dir_ea="evaluation_massive/celebA_custom_diffusion_351_adjust_embedding_v4/rho0.2_alpha0.5"\
...
for custom_prompt in objectA objectB full_prompt; do
    CUDA_VISIBLE_DEVICES=2 python investigate_clip_sim_v2.py \
        --images_folder="evaluation_massive/celebA_custom_diffusion_351/<woman>/gen_prompt_actions_woman/1000" \
        --prompt_file="prompts/gen_prompt_actions_woman.csv" \
        --num_images=50 \
        --use_custom_prompt=$custom_prompt \
        --info="use_custom_prompt_$custom_prompt" \
        --sub_folder="None" \
        --output_dir="semantic_drift/celebA_custom_diffusion_351/1000"
done

for custom_prompt in objectA objectB full_prompt; do
    CUDA_VISIBLE_DEVICES=2 python investigate_clip_sim_v2.py \
        --images_folder="evaluation_massive/celebA_custom_diffusion_351_adjust_embedding_v4/rho0.2_alpha0.5/<woman>/gen_prompt_actions_woman/1000" \
        --prompt_file="prompts/gen_prompt_actions_woman.csv" \
        --num_images=50 \
        --use_custom_prompt=$custom_prompt \
        --info="use_custom_prompt_$custom_prompt" \
        --sub_folder="None" \
        --output_dir="semantic_drift/celebA_custom_diffusion_351_adjust_embedding_v4/rho0.2_alpha0.5/1000"
done
