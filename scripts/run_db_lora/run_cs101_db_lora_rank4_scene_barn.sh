...
CUDA_VISIBLE_DEVICES=1 accelerate launch --num_processes=1 --main_process_port=29503 train_dreambooth_lora.py \
    ...
    --output_dir="outputs/cs101_db_lora_rank4_scene_barn" \
    --with_prior_preservation --prior_loss_weight=1.0 \
    --instance_prompt="sks barn" \
    --class_prompt="a photo of a barn" \
    --resolution=512 \
    --train_batch_size=1 \
    ...
    --validation_prompt="a photo of a sks barn wearing glasses and writing on a red notebook" \
    --validation_steps=50 \
    --rank=4 \
    --train_text_encoder
...
CUDA_VISIBLE_DEVICES=1 python generate_dreambooth.py \
    ...
    --output_dir="evaluation_massive/cs101_db_lora_rank4_scene_barn/2000" \
...
for custom_prompt in objectA objectB full_prompt; do
    CUDA_VISIBLE_DEVICES=0 python investigate_clip_sim_v2.py \
        --images_folder="evaluation_massive/cs101_db_lora_rank4_scene_barn/2000/sks barn/gen_prompt_cs101_barn" \
        --prompt_file="prompts/gen_prompt_cs101_barn.csv" \
        --num_images=50 \
        --use_custom_prompt=$custom_prompt \
        --info="use_custom_prompt_$custom_prompt" \
        --sub_folder="None" \
        --output_dir="semantic_drift/cs101_db_lora_rank4_scene_barn/2000"
done
