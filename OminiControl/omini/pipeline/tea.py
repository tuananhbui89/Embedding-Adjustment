...
def adjust_linear(vector_to_project, target_vector, rho):
    # rho is the interpolation factor to adjust the vector to the target vector
    # rho = 0 --> vector_to_project is unchanged
    # rho = 1 --> vector_to_project is the target_vector

    assert vector_to_project.shape == target_vector.shape, f"vector_to_project and target_vector should have the same dimension"
