...
export OUTPUT_DIR="./models/cs101_pet_dog_1"  # your save path
export CONFIG="./single_gpu_config.yaml"  # Use RTX 4000 optimized config
export TRAIN_DATA="./cs101/pet_dog1.jsonl"  # your data jsonl file
...
CUDA_VISIBLE_DEVICES=0 accelerate launch --config_file $CONFIG train.py \
    ...
    --subject_test_images "./cs101/pet_dog1/0.jpeg" \
    --test_h 768 \
    --test_w 768 \
...
python infer_subject_with_text_encoder.py \
    ...
    --trained_model_dir="./models/cs101_pet_dog_1" \
    --subject_image_path="cs101/pet_dog1/0.jpeg" \
    --subject_token="SKS" \
    ...
    --cond_size=384 \
    --num_images=50 \
    --output_path="evaluation_massive/output_cs101_pet_dog_1"
...
for rho in 0.3; do
    for alpha in 0.5; do
        python infer_subject_with_tea.py \
            ...
            --target_token="dog" \
            --num_images=50 \
            --output_path="evaluation_massive/output_cs101_pet_dog_1_tea_dog_${rho}_${alpha}"
    done
done
...
for RHO in 0.3; do
  for custom_prompt in objectA objectB full_prompt; do
    CUDA_VISIBLE_DEVICES=0 python investigate_clip_sim_v2.py \
        --images_folder="evaluation_massive/output_cs101_pet_dog_1_tea_${RHO}_0.5" \
        --prompt_file="prompts/gen_prompt_cs101_dog.csv" \
        --num_images=50 \
        --use_custom_prompt=$custom_prompt \
        --info="use_custom_prompt_$custom_prompt" \
        --sub_folder="None" \
        --output_dir="semantic_drift/output_cs101_pet_dog_1_tea_${RHO}_0.5"
  done
done
...
for custom_prompt in objectA objectB full_prompt; do
CUDA_VISIBLE_DEVICES=0 python investigate_clip_sim_v2.py \
    --images_folder="evaluation_massive/output_cs101_pet_dog_1" \
    --prompt_file="prompts/gen_prompt_cs101_dog.csv" \
    --num_images=50 \
    --use_custom_prompt=$custom_prompt \
    --info="use_custom_prompt_$custom_prompt" \
    --sub_folder="None" \
    --output_dir="semantic_drift/output_cs101_pet_dog_1"
done
