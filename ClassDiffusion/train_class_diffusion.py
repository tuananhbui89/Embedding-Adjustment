...
def main(args):
    # # Force single GPU/process mode to avoid NCCL issues
    # import os
    ...
    accelerator = Accelerator(
        ...
        cpu=False,  # Explicitly set to use GPU but single process
    )
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet), accelerator.accumulate(text_encoder):
                ...
                if args.with_prior_preservation:
                    ...
                    if accelerator.num_processes > 1:
                        ...
                        text_embeddings = text_encoder.module.get_input_embeddings().weight
            ...
            if accelerator.is_main_process:
                ...
                if (
                    ...
                    # save images
                    for i, image in enumerate(images):
                        image.save(f"{args.output_dir}/validation_{i}.png")
    ...
    if accelerator.is_main_process:
        ...
        if args.validation_prompt and args.num_validation_images > 0:
            ...
            # save images
            for i, image in enumerate(images):
                image.save(f"{args.output_dir}/test_{i}.png")
